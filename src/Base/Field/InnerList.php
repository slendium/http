...
/**
 * @internal
 * @implements IteratorAggregate<int,IParameterized<Item>>
 * @author C. Fahner
 * @copyright Slendium 2025
 */
class InnerList implements Countable, IteratorAggregate {

	/** @var SplFixedArray<IParameterized<Item>> */
	private readonly SplFixedArray $items;

	/** @param iterable<IParameterized<Item>> $items */
